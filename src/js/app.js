...
import { getBandDefs, bandDefsToState, getFullSpectrumBandDefs } from './bands/factory.js';
...
function exportPresetPack() {
  ...
  const types = ['meditation', 'cyberpunk', 'harp', 'drone', 'fm-binaural', 'tectonic', 'gamma-ascension', 'glitch-matrix', 'chaos-cascade', 'tectonic-breath', 'full-spectrum-48', 'arc-stream', 'arc-orchestra'];
  const names = ['Meditation (432Hz)', 'Cyberpunk (140BPM)', 'Pluck Ensemble', 'Cosmic Drone', 'Crisp FM Binaural', 'Sub-Harmonic Tectonic', 'Neural Gamma Ascension', 'Glitch Matrix', 'Chaos Cascade (500→1)', 'Tectonic Breath', '48-Band Full Spectrum', 'Arc Stream Auto', '36-Band Arc Orchestra'];
